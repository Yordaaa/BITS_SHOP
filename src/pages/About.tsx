      ...
      >
        <div className="mr-auto place-self-center col-span-2 px-20 ml-16">
          ...
          <p className="mb-6 text-gray-800 text-lg md:text-xl ">
            We are a student-focused ecommerce platform designed to facilitate
            peer-to-peer buying and selling, as well as provide lending services
            and product offerings from our college. Our mission is to create a
            convenient and accessible marketplace that caters specifically to
        ...
        <div className="max-w-screen-lg mx-auto px-4">
          ...
          <div className=" p-6 rounded-lg shadow-md">
            <p className="text-gray-700 text-xl leading-relaxed">
              We started this platform because we know students often have
              trouble finding affordable textbooks, school supplies, and other
              important things they need. We thought, why not create an online
              store just for our college, where students can buy and sell
              directly to each other? This way, things will be cheaper and we
              can reuse more stuff.
            </p>
          </div>
        </div>
      </section>
