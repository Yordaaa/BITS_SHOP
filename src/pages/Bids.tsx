...
>>>>>>> 0bbe982c94fa624341f9702aee583c8497e5fddb
                            ...
                            <label className="block font-semibold text-gray-700">
                                <span className="text-sm text-gray-500">Bidder Name:</span> <strong className="text-gray-800">Yerosen</strong>
                            </label>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full p-2.5">
                                <strong className="text-gray-800">Looking forward to this deal!</strong>
                            </div>
                        </div>
