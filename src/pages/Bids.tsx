      ...
      <div className="space-y-4 border-b-2 pb-5 bg-white shadow-md p-5 rounded-lg">
        <div className="border-b pb-4 mb-4">
          ...
          <label className="block font-semibold text-gray-700">
            <span className="text-sm text-gray-500">Bidder ID:</span>{" "}
            <strong className="text-gray-800">1234</strong>
          </label>
          <label className="block font-semibold text-gray-700">
            <span className="text-sm text-gray-500">Bidder Name:</span>{" "}
            <strong className="text-gray-800">Yerosen</strong>
          </label>
        </div>
        ...
        <div>
          ...
          <div className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full p-2.5">
            <strong className="text-gray-800">150</strong>
          </div>
        </div>
        ...
        <div className="flex gap-5">
          ...
          <button
            type="button"
            className="w-full text-white bg-[#E3A57F] hover:bg-opacity-90 font-medium rounded-3xl px-5 py-2 text-center"
          >
            Reject Bid
          </button>
        </div>
