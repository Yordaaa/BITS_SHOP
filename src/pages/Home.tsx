                    ...
                    <div className="pt-20 pb-5">
                        ...
                        <div className="mx-10">
                            <div className="relative w-full max-w-screen-md mx-auto">
                                ...
                                />
                                <button type="submit" onClick={searchHandler} className="text-white absolute end-2.5 bottom-2 bg-primary hover:opacity-90 font-medium rounded-3xl text-sm px-4 py-1 ">
                                    Search
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-12">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">Access a variety of products for rent at competitive prices, allowing you to enjoy what you need without the commitment of a purchase.</p>
                            </div>
                        </div>
                    </div>
                </div>
