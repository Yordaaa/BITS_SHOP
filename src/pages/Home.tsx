    ...
    <div className="max-w-screen-2xl mx-auto">
      ...
      <div className=" py-10">
        ...
        <div className="flex justify-center">
          <button className="bg-primary hover:bg-opacity-90 text-white p-2 px-10 rounded-3xl mt-5">
            Load More
          </button>
        </div>
      </div>
      <div className="bg-white text-center">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <h2 className="text-3xl font-bold tracking-tight leading-none text-gray-900 md:text-4xl">
            Key Features
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-12">
            <div>
              ...
              <p className="text-gray-600">
                Our platform facilitates seamless transactions between students,
                fostering a community-driven marketplace where you can buy and
            ...
            <div>
              ...
              <p className="text-gray-600">
                Borrow and lend items effortlessly while ensuring a secure and
                trustworthy environment, with features that promote responsible
                lending practices.
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-600">
                Access a variety of products for rent at competitive prices,
                allowing you to enjoy what you need without the commitment of a
                purchase.
              </p>
            </div>
          </div>
